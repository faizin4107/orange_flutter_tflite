// #import "OrangeFlutterTflitePlugin.h"

// @implementation OrangeFlutterTflitePlugin
// + (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
//   FlutterMethodChannel* channel = [FlutterMethodChannel
//       methodChannelWithName:@"orange_flutter_tflite"
//             binaryMessenger:[registrar messenger]];
//   OrangeFlutterTflitePlugin* instance = [[OrangeFlutterTflitePlugin alloc] init];
